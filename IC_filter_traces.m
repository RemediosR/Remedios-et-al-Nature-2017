...
outFileName='Filter_Traces.mat'; %saves mean traces using filter outlines as ROIs
outFileName2='Filter_Trace_Sums.mat'; %saves sum of pixels traces using filter outlines as ROIs
pathName='H:\er11\day3\concat\ROItraces';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
outFileName2=[pathName,outFileName2];
...
filterTraceSums=frameSums;
save(outFileName, 'filterTraces');
save(outFileName2, 'filterTraceSums');
